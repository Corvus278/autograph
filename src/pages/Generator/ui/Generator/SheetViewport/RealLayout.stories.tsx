...
/**
 * Область просмотра пробы: примерно центральная колонка окна 1440×900. Рядом
 * с разбивкой лист рисует сам `SheetViewport` экрана — по той же раскладке.
 */
...
const RealLayoutProbe: FC = () => {
  ...
  return (
    <div>
      <p data-testid="layout-page-count">{pages.length}</p>
...
export const Pagination: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const pageCount = await canvas.findByTestId('layout-page-count');
