...
/**
 * Числа полосовой ступени замера периода: по ним видно, что шаг нашёлся
 * полосами, и сверяются пороги её согласия и порог дрейфа перспективы.
 */
export type SheetPhotoBandedReport = {
  /**
   * Шаги согласившихся полос сверху вниз, px.
   */
  steps: number[];
...
export type SheetPhotoDiagnostics = {
  ...
  /**
   * Числа полосовой ступени прохода по кадру — того, что засевает схождение в
   * поиск перспективы. `null` — шаг взял профиль по всему кадру, и полосы не
   * считались.
   *
