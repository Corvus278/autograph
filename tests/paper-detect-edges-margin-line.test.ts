 ...
 * соседних вертикалей. Литералом, а не константой детектора: калибровка
 * барьера правит её число, и проверка разделения классов, взяв его оттуда,
 * молча переписалась бы вместе с ним.
 */
